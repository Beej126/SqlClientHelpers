...
// ReSharper restore PossibleMultipleEnumeration
  ...
  {
    if (enumerable == null) yield return null;
  ...
  {
    //from here: http://stackoverflow.com/questions/311165/how-do-you-convert-byte-array-to-hexadecimal-string-and-vice-versa-in-c
    return (new System.Runtime.Remoting.Metadata.W3cXsd2001.SoapHexBinary(bytes).ToString());
	}

  public static byte[] HexStringToBytes(this string str)
  {
    return (System.Runtime.Remoting.Metadata.W3cXsd2001.SoapHexBinary.Parse(str).Value);
  }

  private static readonly Regex PluralizeKeyword = new Regex("{(s|es)}", RegexOptions.IgnoreCase | RegexOptions.Compiled);
  public static string Pluralize(string text, int count, params object[] parms)
  {
  ...
  private static readonly Type[] NumericTypes = new[] { typeof(Byte), typeof(Decimal), typeof(Double),
